<template>
    <Head title="Crear Cicle" />
    
    <CiclesLayout>
        <h1 style="text-align: center; color: green; font-size: 24px; margin-bottom: 20px;">Crear Nuevo Cicle Formatiu</h1>
